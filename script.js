...
btn.addEventListener("click", () => {
  // 1. Hide entry screen and show celebration
  entry.style.display = "none";
  celebration.classList.remove("hidden");

  // 2. Play Music (Important: must be triggered by a click to work in browsers)
  music.volume = 0.7;
  // We play the music instance fetched from HTML
  music.play().catch(error => {
    console.log("Music play failed. Check file path or user settings:", error);
  });
